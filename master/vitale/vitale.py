...
def choose_search_result():
    ...
    click_by_mouse_on('master/images/vitale/02-choose-vitale.jpg')
    time.sleep(2)
...
def collect_table_data():
    ...
    return select_and_copy_data_from_table(
        'master/images/vitale/03-top-left-corner.jpg',
        'master/images/vitale/04-top-right-corner.jpg',
        'master/images/vitale/05-bottom-right-corner.jpg',
