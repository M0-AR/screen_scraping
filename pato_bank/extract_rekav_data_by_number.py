...
def extract_rekv_numbers(text):
    ...
    # Define the regular expression patterns for the numbers
    pattern_8_digits = r'\b[0-9]{8}\b'
    pattern_11_digits_letters = r'\b[0-9]{2}[a-zA-Z]{3}[0-9]{6}\b'
    pattern_10_digits = r'\b[0-9]{10}\b'
    pattern_9_digits_dash = r'\b[0-9]{3}-[0-9]{5}\b'
    ...
    matches = matches_8_digits + matches_11_digits_letters + matches_10_digits + matches_9_digits_dash
...
df.to_excel('concatenated.xlsx', index=False)
